...
under the four combinations of overlapping vs.\ non-overlapping atom
...
atomic-fact granularity (one row per claim); non-overlapping spans
collapse same-sentence atoms via an interweave-on-tokens rule. Cells
