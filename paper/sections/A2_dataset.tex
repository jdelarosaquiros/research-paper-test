...
\begin{enumerate}
\item \textbf{RAGTruth} \citep{niu2024ragtruth} (License: MIT) is a
...
\item \textbf{FactScore} \citep{min2023} (License: MIT) is a
biography-generation corpus paired with atomic-fact verification
against Wikipedia.
\item \textbf{LongFact} \citep{wei2024} (License: Apache-2.0) is a
...
produced by an atomic-fact verifier rather than human annotators.
