...
the temporal head produces per-token logits under weakly
...
instruction-tuned LLMs, the per-token output reaches token-, sentence-,
and claim-level AUROC competitive with pooled tensor baselines while
