...
sentence- and claim-level verdicts under standard aggregation?
...
detection (Tables~\ref{tab:main},~\ref{tab:sentence},~\ref{tab:claim})
...
QA and summarization, and COMET for translation (WMT19 De-En).
...
Tables~\ref{tab:main},~\ref{tab:sentence},~\ref{tab:claim},
...
Tables~\ref{tab:main},~\ref{tab:sentence},~\ref{tab:claim}, and
