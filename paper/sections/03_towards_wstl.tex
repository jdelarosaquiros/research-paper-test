...
real-time long-form generation: full-tensor probes face a
speed--accuracy tradeoff, where keeping a small pooled tensor loses
accuracy as responses grow long, while scaling the tensor up
sacrifices inference speed by requiring one forward per token. Even when a
...
\paragraph{Full-tensor probes do not scale to long responses.}
