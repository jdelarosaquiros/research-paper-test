...
over long sequences, losing token-level signals.

We introduce a temporal uncertainty localization framework
...
refines the model to rank uncertain regions across claims.
