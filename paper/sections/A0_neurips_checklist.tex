...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} All claims are justified in Sections 4 and 5.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} Yes, see Section 6.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [NA]\\
\textbf{Justification:} The paper does not include any formal, explicit theoretical result.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} All experimental details are provided in Section 5 and Appendix A.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} The code to reproduce all our experiments is provided in \url{https://github.com/BarSGuy/ACT-ViT}.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} All necessary experimental details are available in Section 5 and Appendix A.\\
\textbf{Guidelines:}
\begin{itemize}
\item The answer NA means that the paper does not include experiments.
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} As stated during submission, we committed to including error bars in the final version upon acceptance. We have now added results averaged over 3 random seeds with 1-sigma error bars, reported in Appendix A.3.\\
\textbf{Guidelines:}
\begin{itemize}
\item The answer NA means that the paper does not include experiments.
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} All necessary experimental details are available in Section 5 and\\
\textbf{Guidelines:}
\begin{itemize}
\item The answer NA means that the paper does not include experiments.
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} This paper does not violate any aspect of the code of ethics.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} Please refer to Appendix D.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Question:} Does the paper describe safeguards that have been put in place for responsible release of data or models that have a high risk for misuse (e.g., pretrained language models, image generators, or scraped datasets)?\\
\textbf{Answer:} [Yes]\\
\textbf{Justification:} The paper poses no such risks.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [Yes]\\
\textbf{Justification:} All baselines as well as accessed code and data repositories have been credited throughout Section 5 and Appendix A. For licenses and terms of use please refer to Appendix A.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [NA]\\
\textbf{Justification:} The paper does not release new assets.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [NA]\\
\textbf{Justification:} The paper does not involve crowdsourcing nor research with human subjects.\\
\textbf{Guidelines:}
\begin{itemize}
...
\textbf{Answer:} [NA]\\
\textbf{Justification:} The paper studies the task of Hallucination Detection in LLMs, but the core method development in this research does not involve LLMs as any important, original, or non-standard components.\\
\textbf{Guidelines:}
\begin{itemize}
