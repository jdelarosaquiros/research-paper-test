...
under AND-on-supported aggregation (any unsupported atom flips the
sentence) and claim-level per atomic fact. Temp-ViT (Stage~3)
...
Passage- and atom-length distributions help interpret which
granularities are feasible to supervise: LongFact and FactScore atoms
...
combinations of overlapping vs.\ non-overlapping atom spans at
training and at test time. Non-overlapping span training is required
when atom spans share tokens; otherwise the head over-fits to the
